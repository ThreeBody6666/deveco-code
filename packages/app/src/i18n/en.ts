export const dict = {
  ...
  "provider.custom.models.contextWindow.placeholder": "Context window (optional)",
  "provider.custom.models.maxOutput.label": "Max output",
  "provider.custom.models.maxOutput.placeholder": "Max output (optional)",
  ...
  "home.workbench.title": "Build with DevEco Code",
  "home.workbench.description": "Start a conversation, create a HarmonyOS project, or turn the selected project into a focused task plan.",
  "home.action.session.title": "New conversation",
  "home.action.session.description": "Open a clean chat in the selected project",
  "home.action.project.title": "New project",
  "home.action.project.description": "Choose a target folder and start the project creation guide",
  "home.action.task.title": "New task",
  "home.action.task.description": "Start with a planning prompt and task breakdown",
