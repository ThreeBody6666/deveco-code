...
export const dict = {
  ...
  "provider.custom.models.contextWindow.placeholder": "上下文窗口（可选）",
  "provider.custom.models.maxOutput.label": "最大输出",
  "provider.custom.models.maxOutput.placeholder": "最大输出（可选）",
  ...
  "provider.custom.error.positiveInteger": "请输入大于 0 的整数",
