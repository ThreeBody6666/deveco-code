...
export const DESKTOP_MENU: DesktopMenu[] = [
  {
    ...
    items: [
      ...
      { type: "item", label: "重新加载 Webview", action: "view.reload" },
  ...
  },
  {
    ...
    items: [
      ...
      { type: "separator" },
      { type: "item", label: "重新加载", action: "view.reload", role: "reload" },
  ...
  },
  {
    ...
    label: "帮助",
    items: [
      { type: "item", label: "DevEco Code 文档", href: "https://opencode.ai/docs" },
      { type: "item", label: "支持论坛", href: "https://discord.com/invite/opencode" },
      { type: "item", label: "导出日志...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
